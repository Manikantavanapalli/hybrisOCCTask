 ...
 */
package com.testing.core.constants;

/**
 * Global class for all TestingCore constants. You can add global constants for your extension into this class.
 */
public final class TestingCoreConstants extends GeneratedTestingCoreConstants
{
	public static final String EXTENSIONNAME = "testingcore";


	private TestingCoreConstants()
	{
		//empty
	}
