...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/testingstorefront/electronics/en",
						"https://electronics.local:9002/testingstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/testingstorefront/electronics/en",
						"https://electronics.local:9002/testingstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/testingstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/testingstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/testingstorefront/electronics/en",
						"https://electronics.local:9002/testingstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/testingstorefront",
						"https://electronics.local:9002/testingstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/testingstorefront",
						"https://electronics.local:9002/testingstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/testingstorefront/electronics/en",
						"https://electronics.local:9002/testingstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
