 ...
 */
package com.testing.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(TestingFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TestingFulfilmentProcessConstants.PARENT_PROCESS);
